...
func encodePlayerBmsg(p BenchPlayer) []byte {
	...
	defer PutBuffer(buf)
	enc := NewEncoder(buf)
	enc.WriteFieldHeader(1, 0); enc.WriteVarint(p.Uid)
	enc.WriteFieldHeader(2, 2); enc.WriteString(p.Name)
	enc.WriteFieldHeader(3, 0); enc.WriteVarint(uint64(p.Level))
	enc.WriteFieldHeader(4, 0); enc.WriteVarint(uint64(p.VipLevel))
	enc.WriteFieldHeader(5, 0); enc.WriteVarint(uint64(p.Diamond))
	enc.WriteFieldHeader(6, 0); enc.WriteVarint(p.Gold)
	enc.WriteFieldHeader(7, 0); enc.WriteVarint(uint64(p.Energy))
	enc.WriteFieldHeader(8, 0); enc.WriteVarint(uint64(p.Avatar))
	enc.WriteFieldHeader(9, 0); enc.WriteVarint(uint64(p.GuildId))
	enc.WriteFieldHeader(10, 2); enc.WriteString(p.GuildName)
...
func decodePlayerBmsg(data []byte) BenchPlayer {
	...
	for {
		...
		if err != nil { break }
		switch {
		case tag == 1 && wt == 0: v, _ := dec.ReadVarint(); p.Uid = v
		case tag == 2 && wt == 2: v, _ := dec.ReadString(); p.Name = v
		case tag == 3 && wt == 0: v, _ := dec.ReadVarint(); p.Level = uint32(v)
		case tag == 4 && wt == 0: v, _ := dec.ReadVarint(); p.VipLevel = uint32(v)
		case tag == 5 && wt == 0: v, _ := dec.ReadVarint(); p.Diamond = uint32(v)
		case tag == 6 && wt == 0: v, _ := dec.ReadVarint(); p.Gold = v
		case tag == 7 && wt == 0: v, _ := dec.ReadVarint(); p.Energy = uint32(v)
		case tag == 8 && wt == 0: v, _ := dec.ReadVarint(); p.Avatar = uint32(v)
		case tag == 9 && wt == 0: v, _ := dec.ReadVarint(); p.GuildId = uint32(v)
		case tag == 10 && wt == 2: v, _ := dec.ReadString(); p.GuildName = v
		default: return p
		}
	}
	return p
...
func encodeChatBmsg2(c BenchChatMsg) []byte {
	...
	defer PutBuffer(buf)
	enc := NewEncoder(buf)
	enc.WriteFieldHeader(1, 0); enc.WriteVarint(uint64(c.Channel))
	enc.WriteFieldHeader(2, 0); enc.WriteVarint(uint64(c.SenderId))
	enc.WriteFieldHeader(3, 2); enc.WriteString(c.Sender)
	enc.WriteFieldHeader(4, 2); enc.WriteString(c.Content)
	enc.WriteFieldHeader(5, 0); enc.WriteVarint(c.Time)
	return append([]byte(nil), buf.Bytes()...)
}
...
func decodeChatBmsg(data []byte) BenchChatMsg {
	...
	for {
		...
		if err != nil { break }
		switch {
		case tag == 1 && wt == 0: v, _ := dec.ReadVarint(); c.Channel = uint32(v)
		case tag == 2 && wt == 0: v, _ := dec.ReadVarint(); c.SenderId = uint32(v)
		case tag == 3 && wt == 2: v, _ := dec.ReadString(); c.Sender = v
		case tag == 4 && wt == 2: v, _ := dec.ReadString(); c.Content = v
		case tag == 5 && wt == 0: v, _ := dec.ReadVarint(); c.Time = v
		default: return c
		}
	}
	return c
...
func encodeInputsBmsg(inputs []BenchBattleInput) []byte {
	...
	for _, in := range inputs {
		enc.WriteFieldHeader(1, 0); enc.WriteVarint(uint64(in.PlayerId))
		enc.WriteFieldHeader(2, 0); enc.WriteVarint(uint64(in.HeroId))
		enc.WriteFieldHeader(3, 0); enc.WriteVarint(uint64(in.Action))
		enc.WriteFieldHeader(4, 0); enc.WriteVarint(uint64(in.SkillId))
		enc.WriteFieldHeader(5, 0); enc.WriteVarint(uint64(in.TargetId))
		enc.WriteFieldHeader(6, 0); enc.WriteZigzag(int64(in.X))
		enc.WriteFieldHeader(7, 0); enc.WriteZigzag(int64(in.Y))
		enc.WriteFieldHeader(8, 0); enc.WriteVarint(uint64(in.Dir))
	}
	return append([]byte(nil), buf.Bytes()...)
}
...
func encodeLeaderboardBmsg2(entries []BenchRankEntry) []byte {
	...
	for _, e := range entries {
		enc.WriteFieldHeader(1, 0); enc.WriteVarint(uint64(e.Rank))
		enc.WriteFieldHeader(2, 0); enc.WriteVarint(e.PlayerId)
		enc.WriteFieldHeader(3, 2); enc.WriteString(e.Name)
		enc.WriteFieldHeader(4, 0); enc.WriteVarint(uint64(e.Level))
		enc.WriteFieldHeader(5, 0); enc.WriteVarint(e.Score)
		enc.WriteFieldHeader(6, 2); enc.WriteString(e.Guild)
	}
	return append([]byte(nil), buf.Bytes()...)
}
...
func decodePlayerProto(data []byte) BenchPlayer {
	...
	for len(data) > 0 {
		...
		case protowire.VarintType:
			...
			switch num {
			case 1: p.Uid = v
			case 3: p.Level = uint32(v)
			case 4: p.VipLevel = uint32(v)
			case 5: p.Diamond = uint32(v)
			case 6: p.Gold = v
			case 7: p.Energy = uint32(v)
			case 8: p.Avatar = uint32(v)
			case 9: p.GuildId = uint32(v)
			}
		case protowire.BytesType:
			...
			data = data[n:]
			switch num {
			case 2: p.Name = string(v)
			case 10: p.GuildName = string(v)
			}
		default:
...
func decodeChatProto(data []byte) BenchChatMsg {
	...
	for len(data) > 0 {
		...
		case protowire.VarintType:
			...
			data = data[n:]
			switch num {
			case 1: c.Channel = uint32(v)
			case 2: c.SenderId = uint32(v)
			case 5: c.Time = v
			}
		case protowire.BytesType:
			v, n := protowire.ConsumeBytes(data)
			...
			data = data[n:]
			switch num {
			case 3: c.Sender = string(v)
			case 4: c.Content = string(v)
			}
		default:
			n = protowire.ConsumeFieldValue(num, typ, data)
			if n < 0 { break }
...
func TestBenchmark_SizeComparison(t *testing.T) {
	...
	type row struct {
		Name string; Bmsg, Proto, Mp, JSON int
	}

	rows := []row{
		{"玩家信息 (10 fields)", len(encodePlayerBmsg(player)), len(encodePlayerProto(player)), len(encodeMsgpack(player)), len(encodeJSON(player))},
		{"聊天消息 (5 fields)", len(encodeChatBmsg2(chat)), len(encodeChatProto(chat)), len(encodeMsgpack(chat)), len(encodeJSON(chat))},
		{"战斗输入 (10人×8 fields)", len(encodeInputsBmsg(inputs)), len(encodeInputsProto(inputs)), len(encodeMsgpack(inputs)), len(encodeJSON(inputs))},
		{"排行榜 (100人×6 fields)", len(encodeLeaderboardBmsg2(lb)), len(encodeLeaderboardProto(lb)), len(encodeMsgpack(lb)), len(encodeJSON(lb))},
	}
	...
	t.Logf("║                        体积对比 (bytes)                             ║")
	t.Logf("╠══════════════════════════════════════════════════════════════════════╣")
	t.Logf("║  %-24s │ %6s │ %6s │ %6s │ %6s ║", "场景", "ByteMsg", "Proto", "MsgPk", "JSON")
	t.Logf("╠══════════════════════════════════════════════════════════════════════╣")
	for _, r := range rows {
		t.Logf("║  %-24s │ %6d │ %6d │ %6d │ %6d ║", r.Name, r.Bmsg, r.Proto, r.Mp, r.JSON)
	}
	t.Logf("╚══════════════════════════════════════════════════════════════════════╝")
	t.Logf("")
...
func BenchmarkEncode_Player_ByteMsg(b *testing.B) {
	p := benchMakePlayer(); b.ResetTimer()
	for i := 0; i < b.N; i++ { encodePlayerBmsg(p) }
}
func BenchmarkEncode_Player_Proto(b *testing.B) {
	p := benchMakePlayer(); b.ResetTimer()
	for i := 0; i < b.N; i++ { encodePlayerProto(p) }
}
func BenchmarkEncode_Player_Msgpack(b *testing.B) {
	p := benchMakePlayer(); b.ResetTimer()
	for i := 0; i < b.N; i++ { encodeMsgpack(p) }
}
func BenchmarkEncode_Player_JSON(b *testing.B) {
	p := benchMakePlayer(); b.ResetTimer()
	for i := 0; i < b.N; i++ { encodeJSON(p) }
}

func BenchmarkEncode_Chat_ByteMsg(b *testing.B) {
	c := benchMakeChat(); b.ResetTimer()
	for i := 0; i < b.N; i++ { encodeChatBmsg2(c) }
}
func BenchmarkEncode_Chat_Proto(b *testing.B) {
	c := benchMakeChat(); b.ResetTimer()
	for i := 0; i < b.N; i++ { encodeChatProto(c) }
}
func BenchmarkEncode_Chat_Msgpack(b *testing.B) {
	c := benchMakeChat(); b.ResetTimer()
	for i := 0; i < b.N; i++ { encodeMsgpack(c) }
}
func BenchmarkEncode_Chat_JSON(b *testing.B) {
	c := benchMakeChat(); b.ResetTimer()
	for i := 0; i < b.N; i++ { encodeJSON(c) }
}

func BenchmarkEncode_Battle_ByteMsg(b *testing.B) {
	in := benchMakeBattleInputs(); b.ResetTimer()
	for i := 0; i < b.N; i++ { encodeInputsBmsg(in) }
}
func BenchmarkEncode_Battle_Proto(b *testing.B) {
	in := benchMakeBattleInputs(); b.ResetTimer()
	for i := 0; i < b.N; i++ { encodeInputsProto(in) }
}
func BenchmarkEncode_Battle_Msgpack(b *testing.B) {
	in := benchMakeBattleInputs(); b.ResetTimer()
	for i := 0; i < b.N; i++ { encodeMsgpack(in) }
}
func BenchmarkEncode_Battle_JSON(b *testing.B) {
	in := benchMakeBattleInputs(); b.ResetTimer()
	for i := 0; i < b.N; i++ { encodeJSON(in) }
}

func BenchmarkEncode_Leaderboard_ByteMsg(b *testing.B) {
	lb := benchMakeLeaderboard(); b.ResetTimer()
	for i := 0; i < b.N; i++ { encodeLeaderboardBmsg2(lb) }
}
func BenchmarkEncode_Leaderboard_Proto(b *testing.B) {
	lb := benchMakeLeaderboard(); b.ResetTimer()
	for i := 0; i < b.N; i++ { encodeLeaderboardProto(lb) }
}
func BenchmarkEncode_Leaderboard_Msgpack(b *testing.B) {
	lb := benchMakeLeaderboard(); b.ResetTimer()
	for i := 0; i < b.N; i++ { encodeMsgpack(lb) }
}
func BenchmarkEncode_Leaderboard_JSON(b *testing.B) {
	lb := benchMakeLeaderboard(); b.ResetTimer()
	for i := 0; i < b.N; i++ { encodeJSON(lb) }
}

// ==================== 解码 Benchmark ====================

func BenchmarkDecode_Player_ByteMsg(b *testing.B) {
	data := encodePlayerBmsg(benchMakePlayer()); b.ResetTimer()
	for i := 0; i < b.N; i++ { decodePlayerBmsg(data) }
}
func BenchmarkDecode_Player_Proto(b *testing.B) {
	data := encodePlayerProto(benchMakePlayer()); b.ResetTimer()
	for i := 0; i < b.N; i++ { decodePlayerProto(data) }
}
func BenchmarkDecode_Player_Msgpack(b *testing.B) {
	var p BenchPlayer; data := encodeMsgpack(p); b.ResetTimer()
	for i := 0; i < b.N; i++ { msgpack.Unmarshal(data, &p) }
}
func BenchmarkDecode_Player_JSON(b *testing.B) {
	var p BenchPlayer; data := encodeJSON(p); b.ResetTimer()
	for i := 0; i < b.N; i++ { json.Unmarshal(data, &p) }
}

func BenchmarkDecode_Chat_ByteMsg(b *testing.B) {
	data := encodeChatBmsg2(benchMakeChat()); b.ResetTimer()
	for i := 0; i < b.N; i++ { decodeChatBmsg(data) }
}
func BenchmarkDecode_Chat_Proto(b *testing.B) {
	data := encodeChatProto(benchMakeChat()); b.ResetTimer()
	for i := 0; i < b.N; i++ { decodeChatProto(data) }
}
func BenchmarkDecode_Chat_Msgpack(b *testing.B) {
	var c BenchChatMsg; data := encodeMsgpack(c); b.ResetTimer()
	for i := 0; i < b.N; i++ { msgpack.Unmarshal(data, &c) }
}
func BenchmarkDecode_Chat_JSON(b *testing.B) {
	var c BenchChatMsg; data := encodeJSON(c); b.ResetTimer()
	for i := 0; i < b.N; i++ { json.Unmarshal(data, &c) }
}

func BenchmarkDecode_Battle_ByteMsg(b *testing.B) {
	data := encodeInputsBmsg(benchMakeBattleInputs()); b.ResetTimer()
	for i := 0; i < b.N; i++ {
		dec := NewDecoder(bytes.NewReader(data))
...
func BenchmarkDecode_Battle_Msgpack(b *testing.B) {
	var in []BenchBattleInput; data := encodeMsgpack(in); b.ResetTimer()
	for i := 0; i < b.N; i++ { msgpack.Unmarshal(data, &in) }
}
func BenchmarkDecode_Battle_JSON(b *testing.B) {
	var in []BenchBattleInput; data := encodeJSON(in); b.ResetTimer()
	for i := 0; i < b.N; i++ { json.Unmarshal(data, &in) }
}
